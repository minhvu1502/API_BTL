...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback, GoogleMap.OnMyLocationClickListener, GoogleMap.OnMyLocationButtonClickListener {
    ...
    TextView tv_city, tv_country, tv_date, tv_temp, tv_max_min, tvlat, tvlng;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_map_save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                int flag = 1;
                ArrayList<City> delete = dBhelper.getCityById(id_city);
                if (delete.size() == 0){
                    int id = delete.size()+1;
                    long resultAdd = dBhelper.Insert(Integer.valueOf(id_city),tv_city.getText().toString(),tv_country.getText().toString(),
                            tvlat.getText().toString(), tvlng.getText().toString());
                    if (resultAdd == -1) {
                    ...
                    Toast.makeText(MapsActivity.this, "Bạn đã lưu thành phố này!", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        switch (requestCode) {
            case REQ_CODE_SPEECH_INPUT: {
                if (resultCode == RESULT_OK && null != data) {
                    ...
                    String x = Validate_Place(result.get(0));
                    GetLocation(x);
                }
                break;
            }
    ...
    private void AnhXa() {
        ...
        tvlat = (TextView) findViewById(R.id.tvlatdelete);
        tvlng = (TextView) findViewById(R.id.tvlngdelete);
    }
