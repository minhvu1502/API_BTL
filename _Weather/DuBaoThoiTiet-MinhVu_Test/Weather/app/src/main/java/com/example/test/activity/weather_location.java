...
public class weather_location extends AppCompatActivity {
    ...
    TextView tv_city, tv_country, tv_nhietdo, tv_status, tv_doam, tv_may, tv_gio, tv_date, tv_sunrise, tv_sunset, tv_maxmin, tvGoiY;
                    ...
                    final StringRequest stringRequest_weather = new StringRequest(Request.Method.GET, url_weather, new Response.Listener<String>() {
                        ...
                        public void onResponse(String response) {
                            try {
                                ...
                                if(status.equals("mây cụm")){
                                    tvGoiY.setText("Chú ý: Thời tiết nhiều mây dễ mưa. Nên mang ô hoặc áo mưa khi ra ngoài. " +
                                            "\n -- Thời tiết đẹp để ra ngoài uống cafe với bạn bè.");
                                }else if (status.equals("mây rải rác")){
                                    tvGoiY.setText("Nhắc nhở: Thời tiết ít mây, nắng chiếu vừa ra ngoài nên mang theo mũ và áo chống nắng để bảo vệ cơ thể" +
                                            "\n -- Trời đẹp dành cho những chuyến picnic và dã ngoại, thích hợp với những buổi tham quan và đi chơi xa.");
                                }else if (status.equals("bầu trời quang đãng")){
                                    tvGoiY.setText("Chú ý: THời tiết ít mây đôi lúc không có, nắng chiếu gay gắt. " +
                                ...
                                }else if (status.equals("mưa vừa")){
                                    tvGoiY.setText("Chú ý: Thời tiết có mưa, mưa thường xuyên. " +
                                ...
                                }else if (status.equals("mưa cường độ nặng")){
                                    tvGoiY.setText("Chú ý: Mưa to, mưa lớn không thích hợp ra ngoài nên hạn chế ra ngoài tối đa. Nếu cần di chuyển ưu tiên " +
                                            " các phương tiện có mái che(xe bus, ô tô, ...).");
                                }else if (status.equals("mưa nhẹ")){
                                    tvGoiY.setText("Nhắc nhở: Thời tiết có mưa, mưa lâm thâm, ra ngoài nên mang theo ô. " +
                                            "\n -- Thời tiết thích hợp đi dạo, đi chơi với bạn bè");
                                }else if (status.equals("mây đen u ám")){
                                    tvGoiY.setText("Chú ý: Trời râm, rất nhiều mây, có khả năng mưa đột ngột. Đề nghị mang theo ô hoặc áo mưa khi ra ngoài" +
                                            "\n -- Hạn chế ra đường vì có thể mưa bất chợt từ mưa vừa tới mưa to. " +
                                            "\n -- Ưu tiên làm các buối party tại nhà.");
                                }else if (status.equals("mây thưa")){
                                    tvGoiY.setText("Nhắc nhở: Thời tiết ít mây, nắng chiếu vừa ra ngoài nên mang theo mũ và áo chống nắng để bảo vệ cơ thể" +
                                            "\n -- Trời đẹp dành cho những chuyến picnic và dã ngoại, thích hợp với những buổi tham quan và đi chơi xa.");
                                }else {
    ...
    private void AnhXa() {
        ...
        tvGoiY = (TextView) findViewById(R.id.tvGoiY);
    }
}
